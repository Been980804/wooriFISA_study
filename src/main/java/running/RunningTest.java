...
public class RunningTest {
	...
	public void step01Test() {
		...
		try {
			...
			Member m1 = new Member("이승준", "abc@gmail.com", "20000118");
			Member m2 = new Member("이현빈", "def@gmail.com", "19980804");
			Member m3 = new Member("조성현", "ghi@gmail.com", "19990311");
			Member m4 = new Member("허예은", "jkl@gmail.com", "20010419");
			em.persist(m1);
			em.persist(m2);
			em.persist(m3);
			em.persist(m4);
